...
extern GUI_EXPORT const char *zoom_swipet[];
extern GUI_EXPORT const char *zoom_swipeb[];
extern GUI_EXPORT const char *zoom_swipel[];
extern GUI_EXPORT const char *zoom_swiper[];
