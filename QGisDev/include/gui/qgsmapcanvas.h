...
class GUI_EXPORT QgsMapCanvas : public QGraphicsView
{
  ...
  public:
	...
	enum SwipeMode	{ SwipeLeft, SwipeRight, SwipeTop, SwipeBottom, SwipeNone	};
	...
	//add by liminlu0314@163.com
	//! 卷联时的事件
	void swipeAction( QMouseEvent * event );

	//! 卷联时的事件
	void swipeActionEnd(  );

	//设置卷帘模式
	void setSwipeMode(SwipeMode smode);
  ...
  private:
    ...
    */
	...
	//add by liminlu0314@163.com
	//记录第一个可见图层的layerid,用于卷帘时使用
	QString mSwipeLayerID;

	//记录卷帘方向
	SwipeMode mCurSwipeMode;
