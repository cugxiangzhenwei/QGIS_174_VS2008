...
**
** Created: Tue Mar 13 10:24:03 2012
...
public:
    ...
    void setupUi(QDialog *QgsCustomProjectionDialogBase)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../images/themes/default/mIconFirst.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnFirst->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../images/themes/default/mIconPrevious.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnPrevious->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("../../images/themes/default/mIconNext.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnNext->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../../images/themes/default/mIconLast.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnLast->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("../../images/themes/default/mIconNew.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnNew->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("../../images/themes/default/mActionFileSave.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnSave->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("../../images/themes/default/mIconDelete.png"), QSize(), QIcon::Normal, QIcon::Off);
        pbnDelete->setIcon(icon7);
