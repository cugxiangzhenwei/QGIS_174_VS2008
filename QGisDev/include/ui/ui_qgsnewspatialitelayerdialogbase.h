...
public:
    ...
    void setupUi(QDialog *QgsNewSpatialiteLayerDialogBase)
    {
        ...
        mFileFormatLabel = new QLabel(QgsNewSpatialiteLayerDialogBase);
        ...
        mDatabaseComboBox = new QComboBox(QgsNewSpatialiteLayerDialogBase);
        ...
        toolButtonNewDatabase = new QToolButton(QgsNewSpatialiteLayerDialogBase);
        ...
        label = new QLabel(QgsNewSpatialiteLayerDialogBase);
        label->setObjectName(QString::fromUtf8("label"));

        horizontalLayout_2->addWidget(label);

        leLayerName = new QLineEdit(QgsNewSpatialiteLayerDialogBase);
        ...
        label_2 = new QLabel(QgsNewSpatialiteLayerDialogBase);
        label_2->setObjectName(QString::fromUtf8("label_2"));

        horizontalLayout_4->addWidget(label_2);

        leGeometryColumn = new QLineEdit(QgsNewSpatialiteLayerDialogBase);
        ...
        buttonGroup1 = new QGroupBox(QgsNewSpatialiteLayerDialogBase);
        ...
        gridLayout_4->addWidget(buttonGroup1, 3, 0, 1, 1);

        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setSpacing(6);
        horizontalLayout_3->setObjectName(QString::fromUtf8("horizontalLayout_3"));
        leSRID = new QLineEdit(QgsNewSpatialiteLayerDialogBase);
        leSRID->setObjectName(QString::fromUtf8("leSRID"));
        leSRID->setReadOnly(true);

        horizontalLayout_3->addWidget(leSRID);

        pbnFindSRID = new QPushButton(QgsNewSpatialiteLayerDialogBase);
        ...
        gridLayout_4->addLayout(horizontalLayout_3, 4, 0, 1, 1);

        checkBoxPrimaryKey = new QCheckBox(QgsNewSpatialiteLayerDialogBase);
        checkBoxPrimaryKey->setObjectName(QString::fromUtf8("checkBoxPrimaryKey"));

        gridLayout_4->addWidget(checkBoxPrimaryKey, 5, 0, 1, 1);

        groupBox = new QGroupBox(QgsNewSpatialiteLayerDialogBase);
        ...
        groupBox_2 = new QGroupBox(QgsNewSpatialiteLayerDialogBase);
        ...
        gridLayout_4->addWidget(groupBox_2, 8, 0, 1, 1);
        ...
        QWidget::setTabOrder(mTypeBox, mAttributeView);
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), QgsNewSpatialiteLayerDialogBase, SLOT(accept()));
    ...
    void retranslateUi(QDialog *QgsNewSpatialiteLayerDialogBase)
    {
        ...
        Q_UNUSED(QgsNewSpatialiteLayerDialogBase);
    } // retranslateUi
