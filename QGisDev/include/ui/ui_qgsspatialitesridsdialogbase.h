...
public:
    ...
    {
        QgsSpatialiteSridsDialogBase->setWindowTitle(QApplication::translate("QgsSpatialiteSridsDialogBase", "Select a Spatialite Spatial Reference System", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem = twSrids->headerItem();
        ___qtreewidgetitem->setText(2, QApplication::translate("QgsSpatialiteSridsDialogBase", "Reference Name", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsSpatialiteSridsDialogBase", "Authority", 0, QApplication::UnicodeUTF8));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsSpatialiteSridsDialogBase", "SRID", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Search", 0, QApplication::UnicodeUTF8));
        pbnFilter->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Filter", 0, QApplication::UnicodeUTF8));
        radioButtonSrid->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "SRID", 0, QApplication::UnicodeUTF8));
        radioButtonName->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Name", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(QgsSpatialiteSridsDialogBase);
    } // retranslateUi
