...
public:
    ...
    void setupUi(QDialog *QgsMeasureBase)
    {
        ...
        mcbProjectionEnabled = new QCheckBox(QgsMeasureBase);
        mcbProjectionEnabled->setObjectName(QString::fromUtf8("mcbProjectionEnabled"));

        gridLayout->addWidget(mcbProjectionEnabled, 0, 0, 1, 3);
    ...
    void retranslateUi(QDialog *QgsMeasureBase)
    {
        ...
        mcbProjectionEnabled->setText(QApplication::translate("QgsMeasureBase", "Ellipsoidal", 0, QApplication::UnicodeUTF8));
