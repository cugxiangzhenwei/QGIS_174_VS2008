...
public:
    ...
    {
        QgsFormAnnotationDialogBase->setWindowTitle(QApplication::translate("QgsFormAnnotationDialogBase", "Dialog", 0, QApplication::UnicodeUTF8));
        mBrowseToolButton->setText(QApplication::translate("QgsFormAnnotationDialogBase", "...", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(QgsFormAnnotationDialogBase);
    } // retranslateUi
