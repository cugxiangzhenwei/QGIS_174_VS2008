...
public:
    ...
    void setupUi(QDialog *QgsUniqueValueDialogBase)
    {
        ...
        QgsUniqueValueDialogBase->resize(661, 408);
        ...
        gridLayout->addWidget(mClassListWidget, 2, 0, 3, 1);
        ...
        mCommonPropertyLock = new QCheckBox(QgsUniqueValueDialogBase);
        mCommonPropertyLock->setObjectName(QString::fromUtf8("mCommonPropertyLock"));
        mCommonPropertyLock->setChecked(true);

        gridLayout->addWidget(mCommonPropertyLock, 4, 1, 1, 1);
        ...
        QWidget::setTabOrder(mClassifyButton, mAddButton);
        QWidget::setTabOrder(mAddButton, mDeletePushButton);
        QWidget::setTabOrder(mDeletePushButton, mRandomizeColors);
        QWidget::setTabOrder(mRandomizeColors, mResetColors);
        QWidget::setTabOrder(mResetColors, mClassListWidget);
        QWidget::setTabOrder(mClassListWidget, mCommonPropertyLock);
    ...
    void retranslateUi(QDialog *QgsUniqueValueDialogBase)
    {
        ...
        mCommonPropertyLock->setText(QApplication::translate("QgsUniqueValueDialogBase", "Restrict changes to common properties", 0, QApplication::UnicodeUTF8));
