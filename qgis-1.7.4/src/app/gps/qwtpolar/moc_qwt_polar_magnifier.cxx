...
static const char qt_meta_stringdata_QwtPolarMagnifier[] = {
    "QwtPolarMagnifier\0"
};
...
const QMetaObjectExtraData QwtPolarMagnifier::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QwtPolarMagnifier::staticMetaObject = {
    { &QwtMagnifier::staticMetaObject, qt_meta_stringdata_QwtPolarMagnifier,
      qt_meta_data_QwtPolarMagnifier, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QwtPolarMagnifier::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtPolarMagnifier))
        return static_cast<void*>(const_cast< QwtPolarMagnifier*>(this));
