...
**
** Created: Thu Jun 7 16:58:30 2012
...
static const char qt_meta_stringdata_QwtPolarPanner[] = {
    "QwtPolarPanner\0\0dx,dy\0movePlot(int,int)\0"
};
...
const QMetaObjectExtraData QwtPolarPanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QwtPolarPanner::staticMetaObject = {
    { &QwtPanner::staticMetaObject, qt_meta_stringdata_QwtPolarPanner,
      qt_meta_data_QwtPolarPanner, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QwtPolarPanner::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtPolarPanner))
        return static_cast<void*>(const_cast< QwtPolarPanner*>(this));
