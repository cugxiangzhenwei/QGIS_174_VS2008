    ...
    mRasterLayer( qobject_cast<QgsRasterLayer *>( lyr ) )
{
  ...
  cboxContrastEnhancementAlgorithm->addItem( tr( "2% linear Stretch" ) );
...
void QgsRasterLayerProperties::sync()
{
  ...
  if ( mRasterLayer->dataProvider()->dataType( 1 ) != QgsRasterDataProvider::ARGBDataType )
  {
    ...
    else if ( QgsContrastEnhancement::Clip2PercentToMinMax == mRasterLayer->contrastEnhancementAlgorithm() )
    {
      cboxContrastEnhancementAlgorithm->setCurrentIndex( cboxContrastEnhancementAlgorithm->findText( tr( "2% linear Stretch" ) ) );
    }
	...
	else if ( mDefaultContrastEnhancementAlgorithm == "Clip2PercentToMinMax" )
	{
		labelDefaultContrastEnhancementAlgorithm->setText( tr( "2% linear Stretch" ) );
	}
    else
    {
      labelDefaultContrastEnhancementAlgorithm->setText( tr( "No Stretch" ) );
...
void QgsRasterLayerProperties::apply()
{
  if ( mRasterLayer->dataProvider()->dataType( 1 ) != QgsRasterDataProvider::ARGBDataType )
  {
	...
	else if ( cboxContrastEnhancementAlgorithm->currentText() == tr( "2% linear Stretch" ) )
	{
		mRasterLayer->setContrastEnhancementAlgorithm( QgsContrastEnhancement::Clip2PercentToMinMax, false );
	}
    else if ( QgsContrastEnhancement::UserDefinedEnhancement == mRasterLayer->contrastEnhancementAlgorithm() )
    {
      //do nothing
...
void QgsRasterLayerProperties::on_pbtnMakeContrastEnhancementAlgorithmDefault_clicked()
{
  if ( cboxContrastEnhancementAlgorithm->currentText() != tr( "User Defined" ) )
  {
	...
	{
		mDefaultContrastEnhancementAlgorithm = "Clip2PercentToMinMax";
		labelDefaultContrastEnhancementAlgorithm->setText( cboxContrastEnhancementAlgorithm->currentText() );
	}
    else
    {
